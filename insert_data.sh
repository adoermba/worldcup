...
do
  ...
  then
    ...
    INSERT_INTO_GAMES_RESULT=$($PSQL "INSERT INTO games(year, round, winner_id, opponent_id, winner_goals, opponent_goals) VALUES ('$YEAR','$ROUND', $WINNER_ID, $OPPONENT_ID, $WIN_G, $OPP_G)")
      if [[ $INSERT_INTO_TEAMS_RESULT == "INSERT 0 1" ]]
      then
